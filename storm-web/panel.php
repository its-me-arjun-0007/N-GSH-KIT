    ...
    <div class="main-content">
        <div id="content-area" class="glass-container">
            <div class="default-content">
                <h1 class="glitch" data-text="HackNet">N-GSH-KIT</h1>
                <pp>Welcome to the Next-Gen Social Hacking. </p> <p>  Select an operation from the sidebar to begin.</p>
